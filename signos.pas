...
if (vSigno='Câncer') and (vErro=false)then
   ...
   writeln('');
   writeln('O seu carinho é importante nos dias de hoje, apesar de ser difícil tentar da  a-tenção a todos a sua volta.');
   vExibido:=true;
   writeln('');
   end;   {54}
...
if (vSigno='Libra') and (vErro=false)then
   ...
   writeln('');
   writeln('O seu equilíbrio na vida faz desejar cada vez mais as coisas, tornando-a ambici-osa.');
   vExibido:=true;
   writeln('');
   end;   {57}
...
if (vSigno='Capricórnio') and (vErro=false)then
   ...
   writeln('');
   writeln('Você possui uma imaginação vértil e possui dificuldades para se expressar.');
   vExibido:=true;
   writeln('');
   end;   {60}
       ...
       writeln('');
           ...
           writeln('');
           writeln('Seu romantismo é o que te chama a atenção e sua alegria contagia e incomoda a alguns.');
           vExibido:=true;
           writeln('');
           end;    {62}
